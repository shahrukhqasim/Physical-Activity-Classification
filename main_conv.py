...
for i in range(10):
    ...
    print("Run",i,1);
    a1,b1=network_conv.train_and_get_accuracy(X_1,Y_1,X_t_1,Y_t_1)
    print("Run",i,2);
    a2,b2=network_conv.train_and_get_accuracy(X_2,Y_2,X_t_2,Y_t_2)
    print("Run",i,3);
    a3,b3=network_conv.train_and_get_accuracy(X_3,Y_3,X_t_3,Y_t_3)
    print("Run",i,4);
    a4,b4=network_conv.train_and_get_accuracy(X_4,Y_4,X_t_4,Y_t_4)
